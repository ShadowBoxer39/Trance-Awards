// pages/advertisers.tsx - ADVERTISERS & SPONSORS PAGE
       ...
       <Navigation currentPage="about" />
        ...
        <section className="max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="glass-card rounded-xl p-12 max-w-2xl mx-auto text-center">
            <div className="mb-8">
              <div className="w-40 h-40 rounded-full bg-white flex items-center justify-center mx-auto shadow-lg">
                <Image
        ...
        <section className="max-w-7xl mx-auto px-6 py-16">
          <div className="glass-card rounded-xl p-12 max-w-3xl mx-auto border-2 border-purple-500/30">
            ...
            <div className="space-y-6">
              {/* Email */}
              <div className="flex items-center justify-center gap-4 p-6 bg-gray-900/50 rounded-lg">
              ...
              <div className="pt-6 border-t border-gray-700">
                <p className="text-center text-gray-400 mb-4">עקבו אחרינו ברשתות</p>
            ...
            <div className="mt-8 text-center">
              <a 
                href="mailto:tracktripil@gmail.com?subject=שיתוף פעולה - יוצאים לטראק"
          ...
          <div className="max-w-7xl mx-auto px-6 py-8">
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="flex flex-wrap justify-center gap-6 text-sm">
                ...
                <Link href="/advertisers" className="text-gray-400 hover:text-gray-300 transition">
                  למפרסמים
                </Link>
              </div>
