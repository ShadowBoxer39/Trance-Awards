  ...
  const previousArtists = [
    {
      name: "רון שפרוט",
      stageName: "Shaprut",
      description: "אחד האמנים הכי מחויבים ומבטיחים שהוצגנו, לא כולל כנחד.",
      ...
      spotifyUrl: "https://open.spotify.com/artist/4cxLwi6uCSlmwN1dCLb50si=Hxq7XXO1hAMVnpDJQ_DE8w",
      instagramUrl: "https://www.instagram.com/shaprut_music/"
    },
    {
      name: "איתאי נרדיה",
      stageName: "Nardia",
      description: "חיפשו אמנים ישראלי יוצא לייצג את ארצה, הינו חינו נרדיה.",
      image: "/images/nardia.jpg",
      soundcloudEmbed: "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/soundcloud%253Aplaylists%253A1983888390&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true",
      spotifyUrl: "https://open.spotify.com/artist/0DtnaFlHMCo1UKbcplRQXs?si=c368f7341484e34",
  ...
  return (
    <>
      ...
      <div className="trance-backdrop min-h-screen text-gray-100">
        ...
        {/* Hero */}
        <section className="max-w-7xl mx-auto px-4 sm:px-6 pt-16 sm:pt-20 pb-10 sm:pb-12">
          <div className="max-w-4xl mx-auto text-center">
            <div className="text-5xl sm:text-6xl mb-4 sm:mb-6">🌟</div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold mb-4 sm:mb-5 px-4">אמנים צעירים</h1>
        ...
        <section className="max-w-3xl mx-auto px-4 sm:px-6 pb-12 sm:pb-16">
          <div className="glass-card rounded-xl p-6 sm:p-8 md:p-10 border-2 border-purple-500/30">
            <div className="flex items-center gap-3 mb-4 sm:mb-6">
              <span className="text-2xl sm:text-3xl">🎤</span>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-gradient">הרשמה להופעה בתוכנית</h2>
            </div>
            ...
            <div className="bg-gradient-to-r from-purple-900/40 to-cyan-900/40 border-2 border-purple-500/50 rounded-xl p-4 sm:p-6 mb-6 sm:mb-8">
              <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
                <div className="text-3xl sm:text-4xl">⚠️</div>
                <div>
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 text-white">דרישה חובה להשתתפות</h3>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 sm:gap-3 bg-green-600 hover:bg-green-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold text-base sm:text-lg transition-all transform hover:scale-105 shadow-lg"
                  >
                    ...
                    <span className="text-sm sm:text-base">הצטרף לקהילת הוואטסאפ עכשיו</span>
                  </a>
                </div>
              </div>
            </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold mb-3 sm:mb-4">איך זה עובד?</h2>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            ...
            <div className="glass-card rounded-xl p-5 sm:p-6 text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">1. מלא טופס</h3>
            ...
            <div className="glass-card rounded-xl p-5 sm:p-6 text-center">
              <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">🎧</div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">2. נבדוק את החומר</h3>
              <p className="text-gray-400 text-xs sm:text-sm leading-relaxed">
            ...
            {/* Step 3 */}
            <div className="glass-card rounded-xl p-5 sm:p-6 text-center sm:col-span-2 md:col-span-1">
              <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">🎤</div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">3. הופעה בפודקאסט</h3>
              <p className="text-gray-400 text-xs sm:text-sm leading-relaxed">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <h2 className="text-2xl sm:text-3xl font-semibold mb-6 sm:mb-8 text-center">אמנים שהוצגו בעבר</h2>
          ...
          <div className="space-y-6 sm:space-y-8">
            {previousArtists.map((artist, index) => (
              ...
              >
                ...
                <div className="flex flex-col md:grid md:grid-cols-[280px,1fr] gap-0 md:gap-6">
                  {/* Artist Image */}
                  <div className="relative aspect-[16/9] md:aspect-auto md:h-full bg-gradient-to-br from-purple-600/20 to-cyan-600/20 overflow-hidden">
                    <Image
                      src={artist.image}
                  ...
                  {/* Artist Info */}
                  <div className="flex flex-col p-5 sm:p-6 md:py-6 md:pr-6 md:pl-0">
                    <div className="mb-3 sm:mb-4">
                      <h3 className="text-xl sm:text-2xl font-bold mb-1">{artist.stageName}</h3>
                      <p className="text-gray-400 text-xs sm:text-sm">{artist.name}</p>
                    </div>
                    ...
                    <div className="flex gap-2 sm:gap-3 mt-auto">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="btn-secondary px-4 sm:px-5 py-2.5 rounded-lg text-xs sm:text-sm font-medium flex items-center gap-2 flex-1 justify-center"
                      >
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-center sm:text-right">פרק מיוחד - 4 אמנים צעירים</h2>
          
          <div className="glass-card rounded-xl overflow-hidden border-2 border-purple-500/30">
            <div className="p-5 sm:p-6 md:p-8 bg-gradient-to-r from-purple-900/30 to-transparent">
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                <span className="text-2xl sm:text-3xl">🎵</span>
                <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-gradient">פרק מיוחד - 4 אמנים צעירים</h2>
              </div>
            ...
            <div className="p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-secondary px-4 sm:px-5 py-2.5 rounded-lg text-sm font-medium text-center"
                >
                  צפו ביוטיוב
                </a>
                <a
