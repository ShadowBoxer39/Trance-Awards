// pages/admin.tsx - COMPLETE WORKING VERSION - JUST COPY AND PASTE THIS
  ...
  return (
    <main className="min-h-screen text-white neon-backdrop">
      <div className="max-w-7xl mx-auto p-4 space-y-6">
        ...
        {/* Action Buttons - shown when data loaded */}
        {tally && (
          <>
