...
      {/* REMOVED 'overflow-hidden' HERE TO FIX STICKY NAVIGATION */}
...
        {/* Hero Section with NEW Community Card */}
...
          {/* NEW: Community Submission Card - Replaces Vinyl */}
          <div 
...
                <p className="text-xl font-bold text-transparent bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text">
                  {currentTrack.name}
                </p>
              </div>
            </div>
...
              {/* Chat Bubble Card - NOTE: rounded-tl-none for the bubble shape */}
...
        {/* Video Player & Reactions (Unchanged) */}
