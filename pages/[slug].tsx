// pages/[slug].tsx - V7: Hyper-Glow Experience
        ...
        <section className="py-8 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              {/* COLUMN 2: MEDIA CENTER (Sets & Episodes & Reels) - 2/3 WIDTH - Combined column for visual flow */}
                        ...
                        {artist.festival_sets && artist.festival_sets.length > 0 && (
                            <div className="glass-card-deep p-6 rounded-2xl glass-card-hover">
                                ...
                                {artist.festival_sets.length > 1 && (
                                    <Link href={`https://www.youtube.com/@nevomusic`} target="_blank" className="text-red-400 text-sm mt-3 flex items-center justify-end gap-1 hover:underline">
